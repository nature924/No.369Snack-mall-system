<template>
  <div class="product-type">
    ...
    <el-dialog title="编辑零食类别信息" class="chang-product" :close-on-click-modal="false" :visible.sync="dialogFormVisible" center>
      <el-form class="info-form" inline :rules="alterRules" :model="alterForm" ref='changeFrom'>
        <el-form-item label="零食名称：" prop="typeName" style="width: 100%">
          <el-input size="small" v-model="alterForm.typeName" placeholder="零食名称"></el-input>
        </el-form-item>
        <el-form-item label="零食描述：" prop="typeDescribe" style="width: 100%">
          <el-input size="small" type="textarea" autosize v-model="alterForm.typeDescribe" placeholder="零食描述"></el-input>
        </el-form-item>
